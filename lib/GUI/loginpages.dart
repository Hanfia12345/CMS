...
class _loginState extends State<login> {
  ...
  //         if (value.body != null && value.body.toString().isNotEmpty) {
  //           var res = jsonDecode(value.body) as Map<String, dynamic>;
  ...
  //           Get.snackbar("Error", "Invalid Credentials/Connection Failed",
  ...
  //     Get.snackbar("Error", "Blanck Fields Not Allowed",
  //         snackPosition: SnackPosition.BOTTOM);
  //   }
  // }
  ...
  Future<void> UserLogin() async {
    if (username.text.isNotEmpty && password.text.isNotEmpty) {
      ...
      if (response.statusCode == 200) {
        ...
        if (type == "vendor") {
          print("id =" + vid);
          Get.to(VendorHome(), arguments: "${vid}");
        } else if (type == "customer") {
          Get.to(CustomerHome());
        } else if (type == "deliveryboy") {
          Get.to(HomePage());
